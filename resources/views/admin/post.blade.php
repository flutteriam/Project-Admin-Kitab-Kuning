                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="file" name="image" id="fieldImage" accept="image/*" class="form-control">
                        </div>
...
<script>
    const PATH_IMAGE = `{{ url('/uploads/posts/') }}`
    let table
    let type
    $(document).ready(() => {
            ...
            columns : [
                ...
                { 
                    ...
                    render: function(data, type, row){
                        ...
                        let html = `<img src="${PATH_IMAGE}/${data.image}" alt="${PATH_IMAGE}/${data.image}" class="img-fluid w-50">
